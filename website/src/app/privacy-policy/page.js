  ...
  return (
    <main className="min-h-screen py-20 px-6 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#F9F9F9]/95 backdrop-blur-sm rounded-xl p-8 shadow-xl">
          <h1 className="text-4xl font-bold mb-6 text-center text-[#3478C7]">
            Privacy Policy for Life Buddy
          </h1>

          <div className="text-sm text-[#263238]/70 mb-8 text-center">
            <strong>Last Updated:</strong> September 1st, 2025
          </div>

          <div className="space-y-6 text-[#263238]">
            <section>
            ...
            <section>
              ...
              <h3 className="text-xl font-medium mb-3 text-[#4CAF50]">
              ...
              <h3 className="text-xl font-medium mb-3 text-[#4CAF50] mt-6">
            ...
            <section>
              ...
              <p className="mb-3">
                ...
                <a
                  ...
                  className="font-bold text-xl text-[#3478C7] hover:text-[#FF9800]"
                >
                  Store Support
                </a>
              </p>
            ...
            {/* Coming Soon Message */}
            <div className="bg-gradient-to-r from-[#3478C7]/20 to-[#4CAF50]/20 border border-[#3478C7]/30 rounded-lg p-6 mt-8">
              <h3 className="text-xl font-semibold mb-3 text-[#3478C7]">
                🚀 Website Coming Soon!
              </h3>
              <p className="leading-relaxed">
            ...
            <div className="bg-[#4CAF50]/10 border border-[#4CAF50]/30 rounded-lg p-4 mt-6">
